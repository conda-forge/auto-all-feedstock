...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/auto-all-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14156&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/auto-all-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `auto-all` can be installed with:

```
conda install auto-all
```

It is possible to list all of the versions of `auto-all` available on your platform with:
